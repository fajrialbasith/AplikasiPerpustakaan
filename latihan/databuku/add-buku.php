...
// $queryBUKU = mysqli_query($koneksi, "SELECT max(IdBuku) as maxbuku FROM MasterBuku");
// $data = mysqli_fetch_array($queryBUKU);
// $maxbuku = $data['maxbuku'];

// $noUrut = (int) substr($maxbuku, 3, 3);
// $noUrut++;
// $maxbuku = "BOOK" . sprintf("%03s", $noUrut);
