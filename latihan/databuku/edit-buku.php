...
$databuku = mysqli_query($koneksi, "SELECT * FROM masterbuku WHERE IdBuku = '$IdBuku'");
$data = mysqli_fetch_array($databuku);
            ...
            <div class="card">
                <form action="proses-buku.php" method="POST">
                    <div class="card-header">
                        <span class="h5 my-2"><i class="fa-solid fa-square-pen-to-square me-2 mt-2"></i>Edit Data Buku</span>
